    ...
    <body style="background-color: rgb(249, 247, 247);">
        ...
        <div class="container-fluid home">
            <header class="d-flex flex-wrap justify-content-center py-3 border-bottom">
                ...
                <ul class="nav nav-pills">
                    <li class="nav-item"><a href="./mentordashboard.html" class="nav-link" aria-current="page">Dashboard</a></li>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light StudSearch" aria-label="Offcanvas navbar large">
            <div class="container-fluid">
              <a class="navbar-brand" href="#">Hey, <?php echo htmlspecialchars($_SESSION['first_name']); ?>!!!</a>
