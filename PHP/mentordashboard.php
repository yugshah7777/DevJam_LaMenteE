...
<html lang="en">
        ...
        <div class="container-fluid home" id="nav_bar">
            <header class="d-flex flex-wrap justify-content-between py-3 mb-4 border-bottom shadow">
                ...
                <ul class="nav nav-pills d-none d-lg-flex">
                    ...
                    <li class="nav-item" id="navC"><a href="./mentordashboard.php" class="nav-link">Dashboard</a></li>
                </ul>
                ...
                <div class="dropdown d-lg-none">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item shake-button" href="./mentordashboard.php">Dashboard</a></li>
                    </ul>
                </div>
            </header>
    ...
    const textArray = ["Lead, guide, inspire.", "Grow by lifting others", "Sharing knowledge is the greatest gift."];
    let textIndex = 0;
    let charIndex = 0;
