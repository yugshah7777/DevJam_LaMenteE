...
<html lang="en">
    ...
    <body style="background-color: #F9F7F7;" data-aos="fade-up" class="home">
        ...
        <div class="container-fluid home" id="nav_bar">
            <header class="d-flex flex-wrap justify-content-between py-3 mb-4 border-bottom shadow">
                ...
                <ul class="nav nav-pills d-none d-lg-flex">
                    ...
                    <li class="nav-item" id="navC"><a href="./studentdashboard.php" class="nav-link">Dashboard</a></li>
                </ul>
                ...
                <div class="dropdown d-lg-none">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item shake-button" href="./studentdashboard.php">Dashboard</a></li>
                    </ul>
                </div>
            </header>
        ...
        <div class="container-fluid px-4 py-5 features" id="featured-3">            
            ...
            <div class="row g-4 py-3 row-cols-1 row-cols-lg-3">
                <div class="feature col reveal">
                    ...
                    <h3 class="fs-2">Resource Sharing & Learning Materials</h3>
                    <p>As a mentor, your guidance extends beyond live sessions. With our resource sharing feature, you can upload and share customized learning materials such as PDFs, study guides, presentations, and video tutorials to support your mentees effectively. This allows students to revisit key concepts, reinforce their learning, and stay engaged even outside scheduled mentorship hours.</p>
                </div>
        ...
        const textArray = ["Every expert was once a beginner.", "Your only limit is your mind.", "The journey of learning never ends."];
        let textIndex = 0;
        let charIndex = 0;
